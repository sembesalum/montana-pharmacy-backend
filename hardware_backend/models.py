...
class ProductBatch(models.Model):
    """Product batch model for tracking inventory batches with individual pricing"""
    batch_id = models.CharField(max_length=50, primary_key=True, default=generate_uuid)
...
class Expense(models.Model):
    ...
    expense_id = models.CharField(max_length=50, primary_key=True, default=generate_uuid)
    title = models.CharField(max_length=200)
    ...
    created_by = models.ForeignKey(BusinessUser, on_delete=models.SET_NULL, null=True, related_name='expenses_created')
    approved_by = models.ForeignKey(BusinessUser, on_delete=models.SET_NULL, null=True, blank=True, related_name='expenses_approved')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
