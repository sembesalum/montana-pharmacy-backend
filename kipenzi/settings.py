"""
Django settings for kipenzi project.
...
# SECRET_KEY = config('SECRET_KEY', default='django-insecure-5@iuiw798xppl64^4dhj7^x&sa)k-jy5k&30(67!=rs*s*eq!=')
...
# Media files (user uploads, e.g. product images when S3 is not configured)
MEDIA_URL = '/media/'
...
SMS_USERNAME = os.getenv('SMS_USERNAME', 'MONTANA')  # mShastra profile ID
